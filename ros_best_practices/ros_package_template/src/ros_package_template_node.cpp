...
ros::NodeHandle n2;
ros::Publisher chatter_pub = n2.advertise<geometry_msgs::Twist>("/amiro1/cmd_vel", 1000);
...
int main(int argc, char **argv)
{
 ...
 // ros::init(argc, argv, "amiro1/cmd_vel");

  
  ros::NodeHandle n;

  //ros::Publisher chatter_pub = n.advertise<std_msgs::String>("chatter", 1000);
  //ros::Publisher chatter_pub = n.advertise<geometry_msgs::Twist>("/amiro1/cmd_vel", 1000);
 // ros::Subscriber sub = n2.subscribe("/amiro1/proximity_floor/values",1,floorValue);
  //ros_package_template::RosPackageTemplate rosPackageTemplate(n);
  //ros::Publisher chatter_pub = n.advertise<std_msgs::String>("chatter", 1000);
